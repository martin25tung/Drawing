...
public class DragHelperGridView extends ViewGroup {
  ...
  private class DragCallback extends ViewDragHelper.Callback {
    ...
    @Override
    public int clampViewPositionHorizontal(@NonNull View child, int left, int dx) {  // 限制取得子view的最左邊
      return left;
    }

    @Override
    public int clampViewPositionVertical(@NonNull View child, int top, int dy) { // 限制取得子view的最上面
      return top;
    }
